...
//
//        XCTAssertTrue(
//            image.repositoryTags.contains(where: {
//                $0.repository == "hello-world" && $0.tag == "latest"
//            }))
//    }
//
//    func testListImage() async throws {
//        _ = try await client.images.pullImage(byName: "hello-world", tag: "latest")
//
...
//        let rt = Image.RepositoryTag(
//            "sha256:89b647c604b2a436fc3aa56ab1ec515c26b085ac0c15b0d105bc475be15738fb")
//
//        XCTAssertNil(rt)
//    }
//
//    func testInspectImage() async throws {
//        let _ = try await client.images.get(imageByNameOrId: "nginx:latest")
//    }
//
